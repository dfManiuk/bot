...
public class WeatherRequest implements IRequest {
		 ...
		 if (update.getMessage().hasLocation() == true) {
           	...
           	Location location = update.getMessage().getLocation();
                 ...
                 //	String icon = weatherEntity.getData().get(0).getWeather().getIcon();
                    ...
                    sb.append("<b>Погода ").append("\nТемпература: ") 
                    .append(String.valueOf(weatherEntity.getData().get(0).getTemp()))
                    .append(" °C")
                    .append("\nОщущается как: ")
                    .append(String.valueOf(weatherEntity.getData().get(0).getAppTemp()))
                    .append(" °C")
                    .append("\nОсадки: ")
                    .append(weatherEntity.getData().get(0).getWeather().getDescription())
                    .append("\nНаправление ветра: ")
                    .append(weatherEntity.getData().get(0).getWindCdirFull())
                    .append("\nСкорость ветра: ")
                    .append(String.valueOf(weatherEntity.getData().get(0).getWindSpd()).substring(0,4))
                    .append(" м/с")
                    .append("</b>  ");
...
//                    	.append(")");
		...
		sendMessage.setText("You send /weather");
